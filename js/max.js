				...
				$('#mp_albums1').jcarousel({
				  ...
				  .bind('click',function(){
					...
					$('#mp_content_wrapper').find('.mp_content:visible')
											.hide();
					$('#mp_content_wrapper').find('.mp_content1:visible')
											.hide();
					$('#mp_content_wrapper').find('.mp_content2:visible')
											.hide();
			...
			$('#mp_albums2').jcarousel({
				  ...
				  .bind('click',function(){
					...
					$('#mp_content_wrapper').find('.mp_content2:visible')
											.hide();
												...
												$('#mp_content_wrapper')
												.find('.mp_content1:eq('+ parseInt($this.index()) +')')
											    .fadeIn(1000);
		              */									    
				...
				*/
				$('#mp_content_wrapper').find('.mp_play').bind('click',function(){
					...
					var album_id 	= $this.closest('.mp_songs').attr('id');
				    var song_index	=  $("span").index(this);
...
if(nesne.readyState==4) 
  {
var el = document.getElementById('mahesh');
...
el.innerHTML = nesne.responseText;
				...
				*/
				$('#mp_content_wrapper').find('.mp_content').bind('mouseenter',function(){
					...
					$('#mp_content_wrapper').find('.mp_content1').bind('mouseenter',function(){
					var $this 		= $(this);
					$this.find('.mp_playall').show();
				}).bind('mouseleave',function(){
					var $this 		= $(this);
